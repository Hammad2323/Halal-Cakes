...
const HomePage = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-orange-50 font-sans overflow-hidden">
      ...
      <nav className="relative z-10 bg-pink-100/90 shadow-md px-8 py-6 flex items-center justify-between rounded-b-2xl mt-10 backdrop-blur-md">
       
        <ul className="flex flex-1 justify-end space-x-6 font-bold text-pink-700">
          <li>
        ...
        <div className="flex-none mx-10 -mt-10">
          <img
            src="/logo.png"
        ...
        <ul className="flex flex-1 justify-start space-x-8 font-bold text-pink-700 ml-6">
          <li>
      ...
      <div className="relative z-10 bg-gradient-to-r from-pink-200 via-white to-pink-100 text-center py-12 px-6 mt-10 rounded-3xl shadow-xl border-4 border-black max-w-5xl mx-auto">
        <h2 className="text-6xl font-extrabold text-gray-900 mb-4 drop-shadow-md tracking-wide">
          <span className="text-pink-600">AMIN'S</span> HALAL BAKERY
        </h2>
        <p className="text-lg text-gray-900 font-medium max-w-xl mx-auto leading-relaxed">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 px-6 mt-10 max-w-4xl mx-auto">
        
        <Link to="/cakes">
          <div className="bg-white border-4 border-black p-4 rounded-2xl shadow-lg hover:shadow-2xl transition">
            <h3 className="text-2xl font-semibold text-center text-pink-700 mb-4">
              Pre-designed Cakes
            </h3>
